#SUB REDE PRIVADA
resource "aws_subnet" "int_sub_a_hackathon" {
...
resource "aws_subnet" "int_sub_b_hackathon" {
  vpc_id            = aws_vpc.vpc_hackathon.id
