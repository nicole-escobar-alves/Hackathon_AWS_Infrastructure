#SUB REDE PUBLICA
resource "aws_subnet" "ext_sub_a_hackathon" {
  vpc_id            = aws_vpc.vpc_hackathon.id
...
resource "aws_subnet" "ext_sub_b_hackathon" {
  vpc_id            = aws_vpc.vpc_hackathon.id
